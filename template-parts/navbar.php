    ...
    <div class="container mx-auto px-4 py-6">
        <div class="flex justify-between items-center">
            ...
            <nav id="site-navigation" class="main-navigation hidden md:block">
                ...
                ?>
                    <div>
                        <a href="<?php echo esc_url(home_url('/')); ?>contact" class="px-12 text-base bg-gradient-to-b from-[#FFC900] to-[#F89939] text-white font-semibold py-2 rounded-md hover:bg-[#FDB714] transition-colors duration-200">
                            สมัครสมาชิก
                        </a>
                    </div>
                </div>
