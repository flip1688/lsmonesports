...
<section class="relative min-h-screen w-full flex items-center justify-center py-12">
    ...
    <!-- Form Container -->
    <div class="relative z-10 w-full max-w-md mx-4 py-10">
    <!-- Register Form Card -->
    <div class="bg-gray-400 bg-opacity-30 backdrop-blur-sm rounded-2xl border border-none p-6 shadow-2xl">
        <!-- Logo -->
        <div class="text-center mb-3">
            <img src="<?php echo get_template_directory_uri(); ?>/src/img/ONE-AllSports.webp" 
                 alt="<?php bloginfo( 'name' ); ?>" 
                 class="h-auto w-auto mx-auto mb-2">
        </div>

        <!-- Form Title -->
        <h2 class="text-xl font-bold text-white text-center mb-4">สมัครสมาชิก</h2>

        <!-- Register Form -->
        <form id="register-form" class="space-y-2" method="post" action="">
            ...
            <div>
                <input type="text" 
                       ...
                       name="username" 
                       required
                       class="w-full px-4 py-2 bg-gray-400 bg-opacity-30 border border-gray-300 rounded-lg text-white placeholder-gray-300 focus:border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-300 transition duration-300"
            ...
            <div>
                <div class="relative">
                    <div id="bank-selector" class="w-full px-4 py-2 bg-gray-300 bg-opacity-30 border border-gray-600 rounded-lg text-white cursor-pointer flex items-center justify-between">
            ...
            <button type="submit" 
                    ...
                    class="w-full bg-[#F5D929] text-[#0E0D09] font-semibold py-2.5 px-6 rounded-lg transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50">
                สมัครสมาชิก
            </button>

            <!-- Divider -->
            <div class="text-center text-white text-sm my-2">
                เป็นสมาชิกแล้ว?
            </div>

            <!-- Login Button -->
            <a href="<?php echo esc_url( home_url( '/login' ) ); ?>" 
               class="block w-full text-center bg-[#006EEB] text-white font-semibold py-2.5 px-6 rounded-lg transition duration-300">
                เข้าสู่ระบบ
            </a>

            <?php 
            $line_url = get_option('onesports_line_contact_url', '');
            if (!empty($line_url)): 
            ?>
            <!-- LINE Contact -->
            <div class="text-center mt-3">
                <a href="<?php echo esc_url($line_url); ?>" 
                   ...
                   class="inline-flex items-center justify-center space-x-2 text-white hover:text-[#06C755] transition-colors">
