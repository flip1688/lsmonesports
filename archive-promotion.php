...
<main id="primary" class="site-main min-h-screen">
    <div class="w-full mx-auto">
        <div class="page-header w-full">
            <div class="relative min-h-fit text-center bg-fixed bg-no-repeat"  style="background-image: url('<?php echo get_template_directory_uri(); ?>/src/img/promotion-heading.png'); background-size: auto 100%;">
