...
<main id="primary" class="site-main min-h-screen">
    <div class="w-full mx-auto">
        <div class="page-header w-full">
            <div class="relative min-h-fit text-center bg-fixed bg-no-repeat"  style="background-image: url('<?php echo get_template_directory_uri(); ?>/src/img/promotion-heading.png'); background-size: 100% auto;">
...
แจกโบนัสและสิทธิพิเศษทุกวัน
                            ...
                            <div class="flex-row items-center justify-stretch mt-6">
                                <a href="/register" class="inline-block px-6 py-3 bg-gradient-to-b from-[#FFC900] to-[#F89939] text-white font-medium rounded-md hover:bg-blue-700 transition-colors duration-200">
                                        สมัครสมาชิก
                                </a>
        ...
        <?php if (have_posts()) : ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-7xl mx-auto p-6" id="promotion-list">
                            ...
                            <?php if (has_post_thumbnail()) : ?>
                                <div class="aspect-w-16 aspect-h-9">
                                    <a href="<?php the_permalink(); ?>" class="block h-fit">
                                        <?php the_post_thumbnail('lsm-card-thumb', array('class' => 'w-full h-fit object-cover')); ?>
                                    </a>
                                </div>
                            <?php endif; ?>
            ...
            the_posts_navigation(array(
                'mid_size'  => 2,
                'prev_text' => __('&larr; ก่อนหน้า', 'lsm-sports'),
                'next_text' => __('ถัดไป &rarr;', 'lsm-sports'),
                'class'     => 'pagination mt-12 flex justify-center',
                'before_page_number' => '<span class="bg-gray-900 text-white px-4 py-2 mx-1 rounded-lg border-2" style="border-color: #FF4500;">',
